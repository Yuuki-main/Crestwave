  ...
  return (
    <div className="relative w-full h-80 lg:h-96">
      ...
      <motion.div
        ...
        className="absolute top-0 left-1/2 -translate-x-1/2 w-72 lg:w-80 bg-white rounded-2xl shadow-xl border border-blue-100 overflow-hidden"
      >
        ...
        <div className="p-4 space-y-2">
          <div className="h-3 bg-blue-100 rounded-full w-3/4" />
          <div className="h-3 bg-gray-100 rounded-full w-full" />
          <div className="h-3 bg-gray-100 rounded-full w-5/6" />
          <div className="h-8 bg-blue-500 rounded-lg w-1/2 mt-4" />
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-8 right-4 lg:right-8 w-14 h-14 bg-white rounded-2xl shadow-lg flex items-center justify-center border border-blue-50"
      >
      ...
      <motion.div
        ...
        className="absolute bottom-8 right-8 lg:right-16 w-14 h-14 bg-white rounded-2xl shadow-lg flex items-center justify-center border border-blue-50"
      >
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <motion.div
        ...
        className="absolute bottom-4 left-8 w-12 h-12 bg-blue-500 rounded-full shadow-lg flex items-center justify-center"
      >
...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen pt-16 overflow-hidden bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100">
      {/* Background blobs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-blue-200/40 blur-3xl" />
        <div className="absolute top-1/2 -left-20 w-72 h-72 rounded-full bg-indigo-200/30 blur-3xl" />
        <div className="absolute bottom-0 right-1/3 w-80 h-80 rounded-full bg-blue-100/50 blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div>
            ...
            >
              <a
                href="#services"
                className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3.5 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-blue-200 hover:-translate-y-0.5"
              >
                Explore Services
              ...
              <a
                href="#contact"
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-50 text-gray-700 font-semibold px-6 py-3.5 rounded-xl border border-gray-200 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5"
              >
        ...
        >
          {pillars.map((p, i) => (
            <motion.div
              ...
              className="bg-white/70 backdrop-blur-sm rounded-2xl p-5 border border-white/80 hover:bg-white hover:shadow-md transition-all duration-200"
            >
