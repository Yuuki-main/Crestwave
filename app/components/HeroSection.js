  ...
  return (
    <div className="relative w-full h-80 lg:h-96">
      ...
      <motion.div
        ...
        className="absolute bottom-4 left-8 w-12 h-12 bg-[#00C8F8] rounded-full shadow-lg flex items-center justify-center"
      >
        <svg
          width="24"
          height="24"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div>
            ...
            >
              ...
              optimisation and analytics, Crestwave helps businesses build
              digital systems that are faster, clearer and easier to scale.
            </motion.p>
            ...
            >
              <a
                href="#services"
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-[#F0F0F0] text-[#000000] font-semibold px-6 py-3.5 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-[#00C8F8]/20 hover:-translate-y-0.5"
              >
                Explore Services
                <svg
                  width="16"
